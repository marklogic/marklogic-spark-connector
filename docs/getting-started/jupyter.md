...
```
import os
os.environ['PYSPARK_SUBMIT_ARGS'] = '--jars "/path/to/marklogic-spark-connector-3.1.2.jar" pyspark-shell'
...
The path of `/path/to/marklogic-spark-connector-3.1.2.jar` should be changed to match the location of the connector
